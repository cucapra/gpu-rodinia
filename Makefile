...
all: DIRT CUDA OMP OPENCL

DIRT:
	mkdir -p bin; mkdir -p linux; mkdir -p $(CUDA_BIN_DIR); mkdir -p $(OMP_BIN_DIR); mkdir -p $(OPENCL_BIN_DIR)
...
clean: DIRT CUDA_clean OMP_clean OCL_clean
